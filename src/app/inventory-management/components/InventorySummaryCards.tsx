...
export default function InventorySummaryCards({ categoryFilter }: InventorySummaryCardsProps) {
  ...
  const scopeLabel = `${selectedStore}${categoryFilter && categoryFilter !== 'All Categories' ? ` · ${categoryFilter}` : ''}`;
